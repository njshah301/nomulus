...
package google.registry.mosapi.model.servicemonitoring;
...
public final class ServiceStateSummary {
  ...
  */
  ...
  @Nullable
  private final List<ActiveIncidentsSummary> activeIncidents;

  public ServiceStateSummary(
      String tld, String overallStatus, @Nullable List<ActiveIncidentsSummary> activeIncidents) {
    this.tld = tld;
  ...
  @Nullable
  public List<ActiveIncidentsSummary> getActiveIncidents() {
